...
*/
  	/* class                instance    title       tags mask     iscentered   isfloating   isterminal  noswallow    monitor */
   	...
   	{ "libreoffice-startcenter",NULL,	  NULL,		    1 << 2,	      1,           0,			      0,          -1,         -1 },
   	{ "libreoffice-writer", NULL,			  NULL,		    1 << 2,	      1,           0,			      0,          -1,         -1 },
   	{ "libreoffice-calc",		NULL,			  NULL,		    1 << 2,	      1,           0,			      0,          -1,         -1 },
   	{ "libreoffice-impress",NULL,			  NULL,		    1 << 2,	      1,           0,			      0,          -1,         -1 },
    ...
    { "winbox64.exe",	      NULL,       NULL,       0,            1,           1,           0,           0,         -1 },
  	...
  	{ "vokoscreen",         NULL,       NULL,       1 << 8,       1,           1,           0,           0,         -1 },
  	{ "vokoscreenNG",       NULL,       NULL,       1 << 8,       1,           1,           0,           0,         -1 },
  	{ "SimpleScreenRecorder",NULL,      NULL,       1 << 8,       1,           1,           0,           0,         -1 },
  	{ "xdman-Main",         NULL,       NULL,       0,            1,           1,           0,           0,         -1 },
  	{ "zoom",               NULL,       NULL,       1 << 7,       1,           0,           0,           0,         -1 },
  	{ "arandr",             NULL,       NULL,       0,            1,           1,           0,           0,         -1 },
  	{ "audacious",          NULL,       NULL,       0,            1,           0,           0,           0,         -1 },
  	{ "Dragon",             NULL,       NULL,       0,            1,           1,           0,           0,         -1 },
  	{ "aft-linux-qt",				NULL,				NULL,       1 << 8,		    1,           1,           0,           0,         -1 },
    ...
    { "float-st-pulsemixer",NULL,       NULL,       0,            1,           1,           0,           0,         -1 },
};
...
static Key keys[] = {
  ...
  /*^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^agstr^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ */
	...
	{ MODKEY,			XK_F4,		spawn,		SHCMD(TERMINAL " -c float-st-pulsemixer -g 100x25 pulsemixer; kill -44 $(pidof dwmblocks)") },
  ...
  { MODKEY|ControlMask,           XK_Return, spawn,    SHCMD("tabbed -r 2 st -w '' -e tmux") },
