...
static Key keys[] = {
  ...
  { MODKEY,			          XK_bracketleft,		spawn,		SHCMD("mpc -p 6601 seek -5") },
	...
	// { MODKEY|ControlMask,		XK_m,	 spawn, SHCMD("~/.config/rofi/applet_mpd") },
	{ MODKEY|ControlMask,		XK_m,	 spawn, SHCMD("/home/agung/.config/rofi/bin/menu_mpd") },
  
    /* launch script (dmenu, etc) */
  // { MODKEY,								XK_Escape,        spawn,		SHCMD("sysact") },
  // { MODKEY,								XK_Escape,        spawn,		SHCMD("/home/agung/.config/rofi/applet_powermenu") },
  { MODKEY,								XK_Escape,        spawn,		SHCMD("/home/agung/.config/rofi/bin/menu_powermenu") },
  { MODKEY,								XK_r,             spawn,		SHCMD("/home/agung/.config/rofi/bin/launcher_misc") },
